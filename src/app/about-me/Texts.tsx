  ...
  return (
    <div>
      ...
      <p className="mb-3 text-sm lg:text-lg">
        ...
        Land of the Rising Sun. Join me in exploring hidden stories and
        breathtaking landscapes as we navigate the visual wonders that make
        Japan a perpetual source of inspiration for my
      </p>
    </div>
  );
}
